...
Page({
  ...
  onLoad: function(options) {
    ...
    wx.getStorage({
      ...
      success: function(res) {
        ...
        wx.request({
          url: 'https://www.monodark.cn/test2-maven/selectAdvancedPlayersActivityApplyReformApplier',
          method: 'POST',
          data: {
        ...
        wx.request({
          url: 'https://www.monodark.cn/test2-maven/selectAdvancedPlayersActivityApplyReformSponsor',
          method: 'POST',
          data: {
            sponsor_user_OpenID: that.data.user_OpenID
          },
          header: {
            'content-type': 'application/x-www-form-urlencoded'
          },
  ...
  apply: function(event) {
    ...
    joinMessage[index].apply_state = 1;
    that.setData({
      joinMessageArray: joinMessage
    })
    console.log(joinMessage[index].advanced_players_activity_apply_id)
    console.log(joinMessage[index].sponsor_user_OpenID)
    console.log(app.globalData.userInfo.user_OpenID)
    wx.request({
      url: 'https://www.monodark.cn/test2-maven/changeAdvancedPlayersActivityApplyReformApplyStateToSuccessfulApplication',
      method: 'POST',
      data: {
        advanced_players_activity_apply_id: joinMessage[index].advanced_players_activity_apply_id,
        sponsor_user_OpenID: joinMessage[index].sponsor_user_OpenID,
  ...
  reject: function(event) {
    ...
    var index = event.currentTarget.dataset.index;
    let joinMessage = that.data.joinMessageArray;
    joinMessage[index].apply_state = 2;
    that.setData({
      joinMessageArray: joinMessage
    })
    wx.request({
      url: 'https://www.monodark.cn/test2-maven/changeAdvancedPlayersActivityApplyReformApplyStateToApplicationWasRejected',
      method: 'POST',
      data: {
        advanced_players_activity_apply_id: joinMessage[index].advanced_players_activity_apply_id,
        sponsor_user_OpenID: joinMessage[index].sponsor_user_OpenID,
